...
# Plot3 is a scatter plot of Sub_metering_n by DateTime
#  for n=1, 2, 3 in an overlay style with legend
# Plot3 requirements:
# width=480 pixels heigth=480 pixels
# vertical label "Energy sub metering"
# no points, line only
# legend in upper right showing the 3 Sub_metering values
# specified colors for n=1,2,3 are black, red, blue (respectively)
...
## 2) create PLOT 3
#######################################
# this is an overlay plot of 
# 3 y's against the same x, all data in single dataframe
